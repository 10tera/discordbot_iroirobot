...
module.exports = {
    data:{
        ...
        options:[
            ...
            },
            {
                type: 3,
                name: "user",
                description: "設定したいユーザーのIDを入力してください。",
                required: true
            }
        ]
    },
    execute(interaction,client){
        ...
        fs.readFile("./config.json",{encoding:"utf-8"},(err,file)=>{
            ...
            for(var i=1;i<21;i++){
                if(configdata.teamlist["team"+i].includes(userid)){
                    const embed=new MessageEmbed()
                        .setTitle("申請できません")
                        .setColor("BLUE")
            ...
            configdata.teamlist["team"+team_name].push(userid);
